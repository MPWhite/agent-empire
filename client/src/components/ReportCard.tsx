    ...
    return (
      <div className="bg-red-950/30 border-l-2 border-red-500 px-4 py-3">
        <div className="flex items-center gap-2 mb-1.5">
          ...
          <span className="text-[9px] font-mono text-red-400 uppercase font-bold tracking-widest">
            Breaking
          </span>
  ...
  return (
    <div className="border border-zinc-800 mx-2 my-2">
      ...
      <div className="px-3 py-2.5">
        <div className="text-[11px] text-zinc-300 leading-[1.6] whitespace-pre-line">
          {report.text}
          {report.isStreaming && (
